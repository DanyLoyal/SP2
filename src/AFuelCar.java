...
protected int kmPrLitre;
   ...
   public abstract int getKmPrLitre();// should return how many km the car can drive on 1 litre of fuel.


    @Override
    public String toString() {
        return super.toString()+ "The car uses " + fuelType + " And goes : " + kmPrLitre + "km. pr. litre";
    }
}
